import{d as a,c as n,a as t,o as l}from"./vue.bc01b7cf.js";const p={class:"markdown-body"},e=t(`<h1>List</h1><h3>Intro</h3><p>A list component to show items and control loading status.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { List } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
