import{d as a,c as u,a as t,o as n}from"./vue.f7776e09.js";const l={class:"markdown-body"},e=t(`<h1>Calendar \u65E5\u5386</h1><h3>\u4ECB\u7ECD</h3><p>\u65E5\u5386\u7EC4\u4EF6\u7528\u4E8E\u9009\u62E9\u65E5\u671F\u6216\u65E5\u671F\u533A\u95F4\u3002</p><h3>\u5B89\u88C5\u4F7F\u7528</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Calendar, CalendarRef } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
</code></pre><h3>\u57FA\u7840\u7528\u6CD5</h3><h4>\u9009\u62E9\u5355\u4E2A\u65E5\u671F</h4><p>\u4E0B\u9762\u6F14\u793A\u4E86\u7ED3\u5408\u5355\u5143\u683C\u6765\u4F7F\u7528\u65E5\u5386\u7EC4\u4EF6\u7684\u7528\u6CD5\uFF0C\u65E5\u671F\u9009\u62E9\u5B8C\u6210\u540E\u4F1A\u89E6\u53D1 <code class="">confirm</code> \u4E8B\u4EF6\u3002</p><pre><code class="language-js"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
...
</code></pre><h4>\u9009\u62E9\u591A\u4E2A\u65E5\u671F</h4><p>\u8BBE\u7F6E <code class="">type</code> \u4E3A <code class="">multiple</code> \u540E\u53EF\u4EE5\u9009\u62E9\u591A\u4E2A\u65E5\u671F\uFF0C\u6B64\u65F6 <code class="">confirm</code> \u4E8B\u4EF6\u8FD4\u56DE\u7684 date \u4E3A\u6570\u7EC4\u7ED3\u6784\uFF0C\u6570\u7EC4\u5305\u542B\u82E5\u5E72\u4E2A\u9009\u4E2D\u7684\u65E5\u671F\u3002</p><pre><code class="language-js"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
  <span class="hljs-keyword">const</span> [open, setOpen] = useState(<span class="hljs-literal">false</span>);
  <span class="hljs-keyword">const</span> [date, setDate] = useState(<span class="hljs-literal">null</span>);
...
</code></pre><h4>\u81EA\u5B9A\u4E49\u9009\u4E2D\u503C</h4><p>\u901A\u8FC7 <code class="">setValue</code> \u65B9\u6CD5\uFF0C\u53EF\u5B9A\u4E49\u6216\u91CD\u7F6E\u65E5\u5386\u7684\u9009\u4E2D\u503C\u3002</p><pre><code class="language-js"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
  <span class="hljs-keyword">const</span> [open, setOpen] = useState(<span class="hljs-literal">false</span>);
  <span class="hljs-keyword">const</span> [date, setDate] = useState(<span class="hljs-literal">null</span>);
...
</code></pre><h4>\u81EA\u5B9A\u4E49\u65E5\u671F\u8303\u56F4</h4><p>\u901A\u8FC7 <code class="">mindate</code> \u548C <code class="">maxdate</code> \u5B9A\u4E49\u65E5\u5386\u7684\u8303\u56F4\u3002\u53EF\u4EE5\u662F<code class="">yyyy-MM-dd</code>\u5B57\u7B26\u4E32\u7C7B\u578B\u6216\u6BEB\u79D2\u65F6\u95F4\u6233\u6570\u503C\u3002</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-calendar</span> <span class="hljs-attr">mindate</span>=<span class="hljs-string">&quot;2022-1-1&quot;</span> <span class="hljs-attr">maxdate</span>=<span class="hljs-string">&quot;2022-1-31&quot;</span> /&gt;</span>
</code></pre><p>\u6216</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-calendar</span>
...
</code></pre><h4>\u81EA\u5B9A\u4E49\u65E5\u671F\u6587\u6848</h4><p>\u901A\u8FC7\u4F20\u5165 <code class="">formatter</code> \u51FD\u6570\u6765\u5BF9\u65E5\u5386\u4E0A\u6BCF\u4E00\u683C\u7684\u5185\u5BB9\u8FDB\u884C\u683C\u5F0F\u5316\u3002</p><pre><code class="language-js"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
  <span class="hljs-keyword">const</span> [open, setOpen] = useState(<span class="hljs-literal">false</span>);
  <span class="hljs-keyword">const</span> [date, setDate] = useState(<span class="hljs-literal">null</span>);
  <span class="hljs-keyword">const</span> calendarRef = useRef &lt; CalendarRef &gt; <span class="hljs-literal">null</span>;
