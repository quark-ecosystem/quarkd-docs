import{d as a,c as n,a as t,o as l}from"./vue.cf8abdcb.js";const p={class:"markdown-body"},e=t(`<h1>Tabbar</h1><h3>Introduce</h3><p>Used to switch between different pages.</p><h3>Install</h3><p>If use quark-icons, please install: <code class="">npm install --save quark-icons</code>.</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/tabbar&quot;</span>;
...
</code></pre><h3>Basic Usage</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">QuarkTabbar</span> @<span class="hljs-attr">change</span>=<span class="hljs-string">&quot;onChange&quot;</span>&gt;</span>
...
</code></pre><h3>No icons</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">QuarkTabbar</span> @<span class="hljs-attr">change</span>=<span class="hljs-string">&quot;onChange&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>Home<span class="hljs-tag">&lt;/<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>Mine<span class="hljs-tag">&lt;/<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>Contact<span class="hljs-tag">&lt;/<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">QuarkTabbar</span>&gt;</span>
</code></pre><h3>Active menu</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">QuarkTabbar</span> <span class="hljs-attr">active</span>=<span class="hljs-string">&quot;2&quot;</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">quark-icon-home</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;20&quot;</span> /&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>Home<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">QuarkTabbar</span>&gt;</span>
</code></pre><h3>Fixed at the bottom</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">QuarkTabbar</span> <span class="hljs-attr">fixed</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">quark-icon-home</span> <span class="hljs-attr">size</span>=<span class="hljs-string">&quot;20&quot;</span> /&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>Home<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">QuarkTabbarItem</span>&gt;</span>
