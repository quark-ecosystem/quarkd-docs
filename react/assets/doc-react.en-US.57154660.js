import{d as a,c as n,a as t,o as e}from"./vue.eac8086e.js";const l={class:"markdown-body"},p=t(`<h1>Overlay</h1><h3>Intro</h3><p>Create a mask layer to emphasize specific page elements and prevent users from performing other operations.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Overlay } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
...
</code></pre><h3>Embedded Content</h3><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">Overlay</span> <span class="hljs-attr">open</span>=<span class="hljs-string">&quot;{open}&quot;</span> <span class="hljs-attr">onClose</span>=<span class="hljs-string">&quot;{handleClose}&quot;</span>&gt;</span>
