import{d as a,c as t,a as n,o as e}from"./vue.92847ec3.js";const l={class:"markdown-body"},d=n(`<h1>Calendar</h1><h3>Intro</h3><p>Calendar component for selecting dates or date ranges.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { Calendar, CalendarRef } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;@quarkd/quark-react&quot;</span>;
</code></pre><h3>Basic Usage</h3><h4>Select Single Date</h4><p>The <code class="">confirm</code> event will be emitted after the date selection is completed.</p><pre><code class="language-js"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
  <span class="hljs-keyword">const</span> [open, setOpen] = useState(<span class="hljs-literal">false</span>);
  <span class="hljs-keyword">const</span> [date, setDate] = useState(<span class="hljs-literal">null</span>);

  <span class="hljs-keyword">const</span> close = <span class="hljs-function">() =&gt;</span> setOpen(<span class="hljs-literal">false</span>);
  ...
  <span class="hljs-keyword">const</span> click = <span class="hljs-function">() =&gt;</span> setOpen(<span class="hljs-literal">true</span>);

  <span class="hljs-keyword">const</span> formatFullDate = <span class="hljs-function">(<span class="hljs-params">date</span>) =&gt;</span> {
  ...
  <span class="hljs-keyword">return</span> (
    <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">className</span>=<span class="hljs-string">&quot;demo&quot;</span>&gt;</span>
      ...
      /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">quark-calendar</span> <span class="hljs-attr">open</span>=<span class="hljs-string">{open}</span> <span class="hljs-attr">onClose</span>=<span class="hljs-string">{close}</span> <span class="hljs-attr">onConfirm</span>=<span class="hljs-string">{confirm}</span> /&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span>
  );
};
</code></pre><h4>Select Multiple Date</h4><p>You can select multiple date after setting <code class="">type</code> to <code class="">multiple</code>. In multiple mode, the date returned by the <code class="">confirm</code> event is an array, it contains several selected dates.</p><pre><code class="language-js"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
  <span class="hljs-keyword">const</span> [open, setOpen] = useState(<span class="hljs-literal">false</span>);
  <span class="hljs-keyword">const</span> [date, setDate] = useState(<span class="hljs-literal">null</span>);
  ...
  <span class="hljs-keyword">const</span> formatMultiple = <span class="hljs-function">(<span class="hljs-params">dates</span>) =&gt;</span> {
...
</code></pre><h4>Select Date Range</h4><p>You can select a date range after setting <code class="">type</code> to<code class="">range</code>. In range mode, the date returned by the <code class="">confirm</code> event is an array, the first item in the array is the start time and the second item is the end time.</p><pre><code class="language-js"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
  <span class="hljs-keyword">const</span> [open, setOpen] = useState(<span class="hljs-literal">false</span>);
  <span class="hljs-keyword">const</span> [date, setDate] = useState(<span class="hljs-literal">null</span>);
  ...
  <span class="hljs-keyword">const</span> formatRange = <span class="hljs-function">(<span class="hljs-params">dateRange</span>) =&gt;</span> {
...
</code></pre><h4>Quick Select</h4><p>Set <code class="">hideconfirm</code> to <code class="">true</code> to hide the confirm button. In this case, the <code class="">confirm</code> event will be emitted immediately after the selection is completed.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-calendar</span> <span class="hljs-attr">hideconfirm</span>=<span class="hljs-string">&quot;{true}&quot;</span> /&gt;</span>
</code></pre><h4>Custom Selected Value</h4><p>The selected value of the calendar can be defined or reset through the <code class="">setValue</code> method.</p><pre><code class="language-js"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
  <span class="hljs-keyword">const</span> [open, setOpen] = useState(<span class="hljs-literal">false</span>);
  <span class="hljs-keyword">const</span> [date, setDate] = useState(<span class="hljs-literal">null</span>);
  <span class="hljs-keyword">const</span> calendarRef = useRef &lt; CalendarRef &gt; <span class="hljs-literal">null</span>;
  ...
  useEffect(<span class="hljs-function">() =&gt;</span> {
    <span class="hljs-keyword">const</span> { <span class="hljs-attr">current</span>: calendarCurrent } = calendarRef;
    calendarCurrent.setValue(<span class="hljs-keyword">new</span> <span class="hljs-built_in">Date</span>());
  }, []);
  ...
  <span class="hljs-keyword">return</span> (
    <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">className</span>=<span class="hljs-string">&quot;demo&quot;</span>&gt;</span>
      ...
      /&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">quark-calendar</span>
        <span class="hljs-attr">ref</span>=<span class="hljs-string">{calendarRef}</span>
        <span class="hljs-attr">open</span>=<span class="hljs-string">{open}</span>
        <span class="hljs-attr">onClose</span>=<span class="hljs-string">{close}</span>
        <span class="hljs-attr">onConfirm</span>=<span class="hljs-string">{confirm}</span>
      /&gt;</span>
...
</code></pre><h4>Custom Date Range</h4><p>Use <code class="">mindate</code> and <code class="">maxdate</code> to custom date range. It can be a <code class="">yyyy-MM-dd</code> string type or a timestamp value.</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-calendar</span> <span class="hljs-attr">mindate</span>=<span class="hljs-string">&quot;2022-1-1&quot;</span> <span class="hljs-attr">maxdate</span>=<span class="hljs-string">&quot;2022-1-31&quot;</span> /&gt;</span>
</code></pre><p>Or</p><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-calendar</span>
  <span class="hljs-attr">mindate</span>=<span class="hljs-string">&quot;{new Date().getTime()}&quot;</span>
  <span class="hljs-attr">maxdate</span>=<span class="hljs-string">&quot;{new Date().getTime() + + 15552000000}&quot;</span>
/&gt;</span>
...
</code></pre><h4>Custom Day Text</h4><p>Use <code class="">formatter</code> to custom day text.</p><pre><code class="language-js"><span class="hljs-keyword">export</span> <span class="hljs-keyword">default</span> () =&gt; {
  <span class="hljs-keyword">const</span> [open, setOpen] = useState(<span class="hljs-literal">false</span>);
  <span class="hljs-keyword">const</span> [date, setDate] = useState(<span class="hljs-literal">null</span>);
  <span class="hljs-keyword">const</span> calendarRef = useRef &lt; CalendarRef &gt; <span class="hljs-literal">null</span>;
  ...
  <span class="hljs-keyword">const</span> dayFormatter = <span class="hljs-function">(<span class="hljs-params">day</span>) =&gt;</span> {
