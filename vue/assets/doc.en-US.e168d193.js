import{d as a,c as n,a as t,o as l}from"./vue.f15dace4.js";const p={class:"markdown-body"},c=t(`<h1>ActionSheet</h1><h3>Intro</h3><p>The pop-up modal panel at the bottom contains multiple options related to the current situation.</p><h3>Install</h3><pre><code class="language-ts"><span class="hljs-keyword">import</span> ActionSheet <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkd/lib/action-sheet&quot;</span>;
