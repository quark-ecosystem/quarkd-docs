import{d as a,c as n,a as l,o as t}from"./vue.888e0505.js";const p={class:"markdown-body"},e=l(`<h1>List</h1><h3>Intro</h3><p>A list component to show items and control loading status.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/list&quot;</span>;
...
&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">quark-list</span>&gt;</span>
</code></pre><h3>PullRefresh</h3><p>Can be used with <code class="">pullrefresh</code> component.</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/pullrefresh&quot;</span>;
