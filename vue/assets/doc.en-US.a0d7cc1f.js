import{d as t,c as a,a as n,o as l}from"./vue.09bc07b7.js";const e={class:"markdown-body"},p=n(`<h1>VirtualList</h1><h3>Intro</h3><p>Virtual list is often used to render a list with a very large amount of data. It can ensure that only the current visible area is rendered, and other parts are rendered after the user scrolls into the visible area. The smoothness of the page is guaranteed.</p><h3>Install</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> <span class="hljs-string">&quot;quarkd/lib/virtuallist&quot;</span>;
