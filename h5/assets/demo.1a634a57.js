...
import { _ as _export_sfc, r as ref, o as onBeforeMount, u as useTranslate, c as createElementBlock, a as createBaseVNode, t as toDisplayString, b as openBlock } from "./mobile.fe39978c.js";
import { o as onBeforeRouteLeave } from "./vue-router.ac40afb4.js";
...
const _hoisted_12 = ["content", "open"];
const _hoisted_13 = {
  slot: "title",
  style: { "color": "red", "font-size": "16px", "margin-bottom": "14px" }
};
const _hoisted_14 = ["open", "content"];
const _hoisted_15 = ["title"];
const _hoisted_16 = ["title"];
const _hoisted_17 = ["title", "open"];
const _hoisted_18 = {
  slot: "footer",
  class: "custom-footer"
};
const _hoisted_19 = ["open", "title", "content"];
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("quark-dialog", {
      ...
      createBaseVNode("div", _hoisted_13, toDisplayString(_ctx.translate("customTitle")), 1)
    ], 40, _hoisted_12),
    createBaseVNode("quark-dialog", {
      notitle: "",
      open: _ctx.open5,
    ...
    createBaseVNode("h2", null, toDisplayString(_ctx.translate("customFooterTitle")), 1),
    createBaseVNode("quark-cell-group", null, [
      createBaseVNode("quark-cell", {
        islink: "",
