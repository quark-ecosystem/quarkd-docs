;(function(){System.register(['./mobile-legacy.294efe64.js'],function(exports){'use strict';var inject,onUnmounted,onDeactivated,onActivated;return{setters:[function(module){inject=module.i;onUnmounted=module.j;onDeactivated=module.k;onActivated=module.l;}],execute:function(){exports('o',onBeforeRouteLeave);/*!
        * vue-router v4.2.2
