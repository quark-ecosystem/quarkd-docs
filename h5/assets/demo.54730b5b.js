import { _ as _export_sfc, r as ref, o as onBeforeMount, u as useTranslate, c as createElementBlock, a as createBaseVNode, t as toDisplayString, T as Toast, b as openBlock } from "./mobile.06fe41ca.js";
import { c as createComponent } from "./component.1061df78.js";
...
const _hoisted_38 = { shrink: "" };
const _hoisted_39 = ["label"];
const _hoisted_40 = ["label"];
const _hoisted_41 = ["label"];
const _hoisted_42 = ["label"];
const _hoisted_43 = { class: "demo-item" };
const _hoisted_44 = {
  sticky: "",
  offsettop: "17vw"
};
const _hoisted_45 = ["label"];
const _hoisted_46 = ["label"];
const _hoisted_47 = ["label"];
const _hoisted_48 = ["label"];
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    createBaseVNode("h2", null, toDisplayString(_ctx.translate("title.shrink")), 1),
    ...
    createBaseVNode("div", _hoisted_43, [
      createBaseVNode("quark-tabs", _hoisted_44, [
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[0]
        }, toDisplayString(_ctx.translate("tabs")[0]), 9, _hoisted_45),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[1]
        }, toDisplayString(_ctx.translate("tabs")[1]), 9, _hoisted_46),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[2]
        }, toDisplayString(_ctx.translate("tabs")[2]), 9, _hoisted_47),
        createBaseVNode("quark-tab-content", {
          label: _ctx.translate("tab")[3]
        }, toDisplayString(_ctx.translate("tabs")[3]), 9, _hoisted_48)
      ])
    ])
  ]);
}
